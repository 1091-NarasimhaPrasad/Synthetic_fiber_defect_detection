...
Original file is located at
    https://colab.research.google.com/drive/1f6ExhKQ5xBAScDu6fs8BANSq8OwqBMGc
"""
...
# Compile the model
resnet_custom_model.compile(loss='binary_crossentropy',
                            optimizer='adam',
                            metrics=['accuracy'])
# Define early stopping criteria
early_stopping = EarlyStopping(monitor='val_loss', patience=4, restore_best_weights=True)
# Train the model
history_resnet = resnet_custom_model.fit(X_train, y_train, epochs=10, batch_size=50,
                                         validation_data=(X_test, y_test), callbacks=[early_stopping])

# Evaluate the model
test_loss, test_acc = resnet_custom_model.evaluate(X_test, y_test)
